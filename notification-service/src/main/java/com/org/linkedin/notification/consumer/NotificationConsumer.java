...
public class NotificationConsumer {
    ...
    public void consumeConnectionRequest(@Payload ConnectionRequestedEvent event) {
        ...
        Notification notification = saveNotification(event.getReceiverId(), event.getSenderId(), "CONNECTION_REQUEST", "You have a new connection request.");
    ...
    public void consumeConnectionAccepted(@Payload ConnectionAcceptedEvent event) {
        ...
        Notification notification = saveNotification(event.getRequesterId(), event.getReceiverId(), "CONNECTION_ACCEPTED", "Your connection request was accepted.");
        notificationPublisher.pushNotification(notification);
    }
    ...
    private Notification saveNotification(java.util.UUID recipientId, java.util.UUID senderId, String type, String message) {
