...
/**
 * Centralized Redis Caching Configuration for all microservices. Provides a unified serialization
 * strategy and default TTL policies.
 */
@Configuration
@EnableCaching
public class BaseCacheConfig {
  ...
  /**
   * Configures a unified RedisCacheManager. Uses String serialization for keys and JSON
